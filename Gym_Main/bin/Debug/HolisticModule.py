...
class holistDetector():
    def __init__(self,static_image_mode=False,upper_body_only=False,smooth_landmarks=True,
        ...
        self.holistic = self.mp_holistic.Holistic(self.static_image_mode ,self.upper_body_only,self.smooth_landmarks,
    ...
    def findHands(self, img, draw=True):
        ...
        if self.results.right_hand_landmarks:
            #for handLms in self.results.right_hand_landmarks:
                if draw:
